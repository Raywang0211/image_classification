...
if __name__=="__main__":
    ...
    root_dir_test = "/home/ray/project/image_classification/data/vechicles/test"
    MM.load_dataset(root_dir_train,root_dir_test)
    train_layer = 100
    epoch = 500
    MM.start_train(root_dir_train, root_dir_test, train_layer, epoch)
    # test = "/home/ray/project/image_classification/data/vechicles/testing"
    # MM.start_inference(root_dir_train, test)
